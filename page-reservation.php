...
<div class="fullscreen reservation">
    <div class="middle">
        <div class="text-center" style="margin-top: -100px; line-height: 5;">
            <img class="hidden-xs" src="<? bloginfo('template_directory') ?>/compass/images/reservation/title.png" srcset="<? bloginfo('template_directory') ?>/compass/images/reservation/title@2x.png 2x"><br>
            <img class="visible-xs-inline" style="width: 300px;" src="<? bloginfo('template_directory') ?>/compass/images/reservation/title.png" srcset="<? bloginfo('template_directory') ?>/compass/images/reservation/title@2x.png 2x"><br>
