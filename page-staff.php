    ...
    <div class="container" style="padding-top: 60px; padding-bottom: 60px;">
        ...
        <div class="row" style="margin-top: 60px;">
            ...
            <div class="col-sm-6">
                ...
                <br>
                <h5 class="bold">自己紹介</h5>
                <p class="line-height-2">
                    歯並びがきれいになってきたことを喜んでくれる患者さんの笑顔をみた時、このうえない喜びを感じます。
                </p>
            </div>
        </div><!-- /.row -->
        ...
        <div class="row" style="margin-top: 60px;">
            ...
            <div class="col-sm-6">
                ...
                <p class="line-height-2">
                    1983年生まれ　33歳 / 2002年　札幌北高校卒業 /  2008年　北海道大学歯学部卒業 / 2008年　北海道病院歯科診療センター研修医、第２補綴教室入局 / 2009年〜2016年　札幌市内や千葉県柏市にて勤務医 / 2016年　「矯正歯科egao」副院長 / 顎咬合学会　咬み合わせ認定医
                </p>
                <br>
                <h5 class="bold">自己紹介</h5>
                <p class="line-height-2">
                    もうすぐ２歳の男の子のママです。ついママ目線で子供と接してしまいます。<br>
                    子供とママに寄り添った、優しくあたたかいケア、キュアを心がけています。<br>
                    パン・お菓子づくりにはちょっと凝っていますのでいつかごちそうします!
                </p>
            </div>
        </div><!-- /.row -->
    </div><!-- /.container -->
