        ...
        <div class="row" style="margin-top: 60px;">
            <div class="col-sm-6 col-md-5 col-md-offset-1">
                ...
                <p class="line-height-2">
                    ...
                    私は矯正歯科の専門医です。どうぞ安心してお任せ下さい。<br>
                    ですが、私はまだ発展途上でもあります。なぜなら矯正治療の考え方・矯正治療の装置も日々多くの勤勉な研究者の努力によって進化しているからです。(パソコンも携帯電話もどんどんアップデートされるのと同じです。)これまで学んできたことと経験してきたことに、これからの最新の考え方・目立ちにくい装置（これが患者さんにとっては一番重要な問題でしょうか？）を日々取り入れて診療を行っていきます。また、矯正治療中に虫歯ができるのは何としても避けなくてはなりませんので装置装着前に、唾液検査・歯磨き指導・全体クリーニングを全員に必ず行います。
                </p>
            </div>
